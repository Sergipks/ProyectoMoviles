...
public final class TrabajadorLayoutBinding implements ViewBinding {
  @NonNull
  ...
  private TrabajadorLayoutBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static TrabajadorLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static TrabajadorLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.trabajador_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static TrabajadorLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new TrabajadorLayoutBinding((ConstraintLayout) rootView, linearLayout, tvCodTrabajo,
